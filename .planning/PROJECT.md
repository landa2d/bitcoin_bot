...
**About** *(validated Phase 14, 2026-06-08 — operator-approved; 7/7 must-haves verified in code, 4 browser/editorial items persisted in 14-HUMAN-UAT.md for batch-deploy verify per D-06)*
- [x] **ABOUT-01**: A nav-reachable "What is AgentPulse" page exists, stubbed with the existing about copy (deeper pipeline-diagram content deferred)

**Spacing & polish** *(validated Phase 14, 2026-06-08 — operator-approved; D-05 radius gate + D-04 spacing sweep confirmed in code, perceptual quality persisted in 14-HUMAN-UAT.md)*
