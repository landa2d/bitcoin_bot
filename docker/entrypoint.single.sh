#!/bin/bash
# OpenClaw Bitcoin Agent - Container Entrypoint Script

set -e

echo "============================================"
echo "  OpenClaw Bitcoin Agent Starting..."
echo "============================================"
...
# Start AgentPulse processor in background (if enabled)
if [ "$AGENTPULSE_ENABLED" = "true" ] && [ -x /home/openclaw/agentpulse_processor.py ]; then
    echo "Starting AgentPulse processor..."
